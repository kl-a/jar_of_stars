...
const AVATARS = {
  avatar_01: () => (
    <svg width="64" height="64" viewBox="0 0 64 64" style={{ imageRendering: 'pixelated' }}>
      <rect x="18" y="32" width="28" height="22" fill="#c9b8f0"/>
      <rect x="16" y="14" width="32" height="24" fill="#c9b8f0"/>
      <rect x="10" y="10" width="10" height="10" fill="#c9b8f0"/>
      <rect x="44" y="10" width="10" height="10" fill="#c9b8f0"/>
      ...
      <rect x="38" y="24" width="6"  height="4"  fill="#c9b8f0"/>
